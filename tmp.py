...
"border-radius: 10px;")
        ...
        self.native_lang_verb_word = QtWidgets.QLabel(self.layoutWidget_13)
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.native_lang_verb_word.setFont(font)
        self.native_lang_verb_word.setStyleSheet("background-color: rgb(249, 240, 107);\n"
"margin:10px;\n"
"border-radius:10px;")
        self.native_lang_verb_word.setText("")
        self.native_lang_verb_word.setAlignment(QtCore.Qt.AlignCenter)
        self.native_lang_verb_word.setObjectName("native_lang_verb_word")
        self.verticalLayout_3.addWidget(self.native_lang_verb_word)
...
"margin:10px;")
        ...
        self.native_lang_verb_word.raise_()
